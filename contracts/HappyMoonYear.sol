...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract HappyMoonYear is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   HappyMoonYearDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Happy Moon Year", "Boolish") {
        _buyRewardsFee = 0;
        _buyLiquidityFee = 1;
		_buyMarketingFee = 6;
        _buyDevFee = 1;
        ...
        _maxWallet = 2000000000 * (10**18);
        _maxBuy = 500000000 * (10**18);
        _maxSell = 500000000 * (10**18);
    	...
    	dividendTracker = new HappyMoonYearDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x007B3ca6c7fAfB31f5bd8f0f3DE9Df76c649a770);
        _devWallet = payable(0xe19aEdE1C46dA39239DE4Bd19e4feC53EAF848cf);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Happy Moon Year: The dividend tracker already has that address");

        HappyMoonYearDividendTracker newDividendTracker = HappyMoonYearDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Happy Moon Year: The new dividend tracker must be owned by the Happy Moon Year token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "Happy Moon Year: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Happy Moon Year: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Happy Moon Year: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Happy Moon Year: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Happy Moon Year: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Happy Moon Year: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Happy Moon Year: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Happy Moon Year: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Happy Moon Year: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Happy Moon Year: Cannot update gasForProcessing to same value");
...
contract HappyMoonYearDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Boolish_Dividend_Tracker", "Boolish_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "Boolish_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Happy Moon Year contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "Boolish_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Boolish_Dividend_Tracker: Cannot update claimWait to same value");
