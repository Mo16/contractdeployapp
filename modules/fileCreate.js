...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
    ...
    address public DividendsToken = address(${DividendsAddress});
...
contract TokenContract is Context, ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("${contractName}", "${contractTikker}") {
        ...
        _devWallet = payable(${devWalletAddress});
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(false, "Token_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "Token_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
